...
{
	public class CalculateFlushHandlerTests
	{
		[Theory]
		[ClassData(typeof(HandCombinations))]
		public void Handler_WhenCalled_CalculatesFlushPoints(Card[] hand, Card cutCard, bool isCrib, int expectedPoints)
		{
			var sut = new CalculateFlushHandler();
